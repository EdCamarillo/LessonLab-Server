...
exports.createQuizPrompt = exports.createPrompt = void 0;
const context_1 = require("./context");
async function createPrompt(messages, namespaceId, specifications) {
    ...
    try {
        ...
        let context;
        try {
            context = await (0, context_1.getContext)(lastMessage, namespaceId);
        }
        catch (error) {
            throw error;
        }
...
async function createQuizPrompt(items, namespaceId, specifications) {
    try {
        // Get the last message
        let lastMessage = '[]';
        if (items) {
...
exports.createQuizPrompt = createQuizPrompt;
//# sourceMappingURL=promptCreation.js.map