...
class TransactionController {
     ...
     */
    async createTokenPurchaseCheckoutSession(req, res) {
        ...
        const reference_number = (0, uuid_1.v4)();
        ...
        try {
            const response = await fetch('https://api.paymongo.com/v1/checkout_sessions', {
                ...
                headers: {
                    ...
                    authorization: `Basic ${(0, core_1.toBase64)(process.env.NEXT_PUBLIC_PM_API_KEY + ':')}`,
                },
                body: JSON.stringify({
                    data: {
                        attributes: {
    ...
    async getTokenPurchaseCheckoutSessionStatus(req, res) {
        try {
            ...
            const result = await connection.execute("UPDATE Users SET Tokens = Tokens + ? WHERE UserID = ?", [tokens, userId]);
